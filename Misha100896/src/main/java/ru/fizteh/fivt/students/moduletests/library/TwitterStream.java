...
public class TwitterStream {
    ...
    public static void runStream(Configuration configuration) {
        ...
        StatusListener statusListener = new StatusAdapter() {
            ...
            public void onStatus(Status tweet) {
                if (!configuration.isHideRetweets() || !tweet.isRetweet()) {
                    ...
                    System.out.print(PrintTweet.printTweet(tweet));
        ...
        if (configuration.getPlace() != null) {
            ...
            MyGeoLocation findPlace = new MyGeoLocation();;
            findPlace.findPlace(configuration.getPlace());
    ...
    public static void findTweets(Configuration configuration) {
        ...
        if (configuration.getPlace() != null) {
            MyGeoLocation googleFindPlace = new MyGeoLocation();
            googleFindPlace.findPlace(configuration.getPlace());
        ...
        try {
            ...
            for (Status tweet: tweets) {
                System.out.print(PrintTweet.printTime(tweet.getCreatedAt()));
